> 参考https://javaguide.cn/cs-basics/operating-system/shell-intro.html，感谢Guide哥！
...
![](https://cdn.jsdelivr.net/gh/SiQuan77/img_bed/202209132155016.png)
...
​	使用 expr 命令时，表达式中的运算符**左右必须包含空格**，如果不包含空格，将会输出表达式本身:
